...
class STeBlueCaidDisplay(Poll, Converter, object):
                    ...
                    if ecm_info:
                        ...
                        if using:
                            ...
                            if using == 'emu':
                                ...
                                if provid == '000000':
                                    textvalue = '%s - %s - HOP:%s - %s %s' % (caid,
                                     ecm_time,
                                     hops,
                                     address,
                                     karte)
                                else:
                                    textvalue = '%s:%s - %s - HOP:%s - %s %s' % (caid,
                                     provid,
                                     ecm_time,
                                     hops,
                                     address,
                                ...
                                textvalue = '%s%s - %s - (local) %s' % (caid,
                                 provid,
                                 ecm_time,
                                 karte)
                            else:
                                textvalue = '%s %s%s - hop:%s - %s %s' % (using,
                                 caid,
                                 provid,
                                 hops,
                                 ecm_time,
                            ...
                            if oscsource:
                                ...
                                if protocol == 'internal':
                                    textvalue = '%s %s:%s - %s - local - %s' % (karte,
                                     caid,
                                     prov,
                                     ecm_time,
                                     oscsource)
                                elif protocol == 'emu':
                                    textvalue = '%s %s:%s - %s - %s' % (karte,
                                     caid,
                                     prov,
                                     ecm_time,
                                     oscsource)
